...
let listProviderMonthAvailiabilityService: ListProviderMonthAvailiabilityService;
...
describe('ListProviderMonthAvailability', () => {
    beforeEach(() => {
        ...
        listProviderMonthAvailiabilityService = new ListProviderMonthAvailiabilityService(
